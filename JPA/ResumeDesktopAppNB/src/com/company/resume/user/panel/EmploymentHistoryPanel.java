...
public class EmploymentHistoryPanel extends javax.swing.JPanel
{
    ...
    {
        if (Config.loggedInUser.getId() != null)
        {
    ...
    private void fillComponentsInformation()
    {
        ...
        listEH.forEach((eh) -> cbEmploymentHistory.addItem(eh));
    }
    ...
    private void fillUserInformation()
    {
        ...
        Date beginDate = employmentHistory.getBeginDate();
        Date endDate = employmentHistory.getEndDate();
    ...
    private void fillEmploymentHistory()
    {
        if (employmentHistory == null)
        {
            ...
            ehdi.addEmploymentHistory(employmentHistory);
        }
        ...
        try
        {
            ...
            if (!begindate.trim().isEmpty() && !begindate.equals("Present"))
                beginDate = new java.sql.Date(sdf.parse(begindate).getTime());
            else
                beginDate = null;

            if (!enddate.trim().isEmpty() && !enddate.equals("Present"))
        ...
        {
            JOptionPane.showMessageDialog(null, "There is mistake in begin date or end date.\nCheck it!");
        }
