...
public class DetailsPanel extends javax.swing.JPanel
{
    ...
    private void fillBirthPlace ()
    {
        ...
        for (Country country: list) cbBirthplace.addItem(country);
    }
    ...
    private void fillNationality ()
    {
        ...
        for (Country country: list) cbNationality.addItem(country);
    }
    ...
    private void fillUserInformation()
    {
        ...
        String birthdate = sdf.format(Config.loggedInUser.getBirthdate());
